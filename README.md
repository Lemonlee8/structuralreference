...
这是一份为结构工程师建立的查清单。基于[Quick Reference](https://github.com/jaywcjlove/reference)开发者技术栈速查清单构建。
...
## 装配式混凝土结构
[钢筋连接器](./docs/couplers.md)<!--rehype:style=background:rgb(34, 123, 147);&class=contributing-->
<!--rehype:class=home-card-->
