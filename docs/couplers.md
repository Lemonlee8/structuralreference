...
| 套筒型号 | 连接钢筋<br/>直径 d1 (mm) | 可连接其它规格<br/>钢筋直径 d (mm) | 套筒外径<br/> d (mm) | 套筒长度<br/> L (mm) | 灌浆端口<br/>孔径 D (mm) | 钢筋插入最<br/>小深度 L1 (mm) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
<img src="../assets/png/JM_coupler.png" alt="JM全灌浆套筒示意图" width="820" />

### JM全灌浆套筒说明
<!--rehype:wrap-class=col-span-1-->
<!-- ![JM全灌浆套筒示意图](../assets/png/JM_coupler.png) -->
**注：**
